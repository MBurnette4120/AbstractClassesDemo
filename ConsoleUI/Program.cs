    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
             ...
             */
            Car import = new Car() { HasTrunk = true, Make = "Nissan", Model = "Altima", Year = "2020" };
            Motorcycle harley = new Motorcycle() { HasHandleBars = true, Make = "Harley Davidson", Model = "Sportster", Year = "2018" };
            Vehicle convertible = new Car() { HasTrunk = true, Make = "Mazda", Model = "Miata", Year = "1995" };
            Vehicle sport = new Car() { HasTrunk = false, Make = "Ferrari", Model = "Testarossa", Year = "2005" };
